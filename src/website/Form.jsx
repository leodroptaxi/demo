 ...
 const calculateEstimate = () => {
    ...
    service.getDistanceMatrix(
      ...
      (response, status) => {
        ...
        // Minimum billing logic (different for one-way & round trip)
        let distanceForCost;
        if (formData.trip_type === "round_trip") {
          distanceForCost = distanceInKm < 230 ? 230 : distanceInKm;
        } else {
          distanceForCost = distanceInKm < 130 ? 130 : distanceInKm;
        }
